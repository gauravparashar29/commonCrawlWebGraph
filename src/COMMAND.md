...
- A JSON report is written for each run under `backlink-reports/<Mon-YYYY>/` in the repo root using the pattern `domain-DD-MM-YYYY.json`.
...
npm run import:competitor-backlinks -- --file=backlink-reports/Apr-2026/brainly.in-21-04-2026.json
